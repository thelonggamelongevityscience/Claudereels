...
export const Scene4HALWhatAccelerates: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const items = [
    { label: 'Chronic stress', body: 'accelerates genomic instability and telomere shortening simultaneously.', op: li1Op, x: li1X },
    { label: 'Poor sleep', body: 'impairs the cellular cleanup systems that should be clearing damage every night.', op: li2Op, x: li2X },
    { label: 'Sedentary behaviour', body: 'worsens mitochondrial dysfunction faster than almost any other single factor.', op: li3Op, x: li3X },
    { label: 'Ultra-processed food', body: 'feeds directly into chronic inflammation and nutrient-sensing dysregulation.', op: li4Op, x: li4X },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 72, lineHeight: 0.92, textTransform: 'uppercase', color: COLORS.white, marginBottom: 28 }}>
        WHAT SPEEDS<br />UP ALL TWELVE<br />AT ONCE.
      </div>
