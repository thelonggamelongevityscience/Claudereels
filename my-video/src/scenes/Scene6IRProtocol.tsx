...
export const Scene6IRProtocol: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const bullets: { delay: number; label: string; text: string }[] = [
    { delay: 28, label: 'Remove seed oils:', text: 'switch to olive oil or butter — this single swap lowers hs-CRP measurably within two weeks' },
    { delay: 40, label: 'Prioritise sleep:', text: 'normalises inflammatory cytokines faster than any supplement — 7–9 hours is not negotiable' },
    { delay: 52, label: 'Add omega-3 daily:', text: 'EPA and DHA directly counter omega-6 excess — 2–4g from fish oil or fatty fish shifts the ratio' },
    { delay: 64, label: 'Zone 2 exercise:', text: '150 minutes a week produces anti-inflammatory adaptations through IL-6 suppression and improved insulin sensitivity' },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      {(['LOWER YOUR', 'INFLAMMATION', 'STARTING TODAY.'] as const).map((text, i) => (
