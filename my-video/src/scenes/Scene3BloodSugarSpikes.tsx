...
export const Scene3BloodSugarSpikes: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const bullets = [
    { delay: 28, label: 'Glycation:', text: 'excess glucose binds to proteins and damages blood vessels, nerves, and organs' },
    { delay: 40, label: 'Oxidative stress:', text: 'each spike triggers a burst of free radicals that damage mitochondria' },
    { delay: 52, label: 'Insulin surge:', text: 'repeated high spikes drive insulin resistance — the root of metabolic syndrome' },
    { delay: 64, label: 'Inflammation:', text: 'glucose variability activates inflammatory pathways independently of average levels' },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      {(['EVERY GLUCOSE', 'SPIKE IS DOING', 'THIS TO YOU.'] as const).map((text, i) => (
