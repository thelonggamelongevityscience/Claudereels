...
export const Scene8SAUCTA: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: headOp, transform: `translateY(${headY}px)`, fontFamily: FONTS.barlow, fontWeight: 700, fontSize: 22, letterSpacing: '0.25em', textTransform: 'uppercase', color: COLORS.ember, marginBottom: 6 }}>
        Longevity Science
      </div>

      <div style={{ width: `${lineW}%`, height: 3, backgroundColor: COLORS.ember, margin: '14px 0 20px' }} />

      <div style={{ opacity: box1Op, transform: `translateY(${box1Y}px)`, border: `1.5px solid ${COLORS.ember}`, padding: '14px 18px', marginBottom: 10 }}>
        <div style={{ fontFamily: FONTS.barlow, fontWeight: 700, fontSize: 26, color: COLORS.ember, letterSpacing: '0.1em', textTransform: 'uppercase' }}>→ Save this</div>
      </div>
      ...
      <div style={{ opacity: box2Op, fontFamily: FONTS.mono, fontSize: 18, color: `${COLORS.ember}88` }}>
        #sauna #heatshockproteins #longevity<br />#cardiovascularhealth #finnishstudy
      </div>
