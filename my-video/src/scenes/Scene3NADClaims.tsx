...
const CLAIMS = [
  { text: 'Raises your blood NAD+ levels',        tag: 'Proven',    style: 'proven' as TagStyle },
  { text: 'Makes you live longer',                tag: 'Not Proven', style: 'hyped'  as TagStyle },
  { text: 'Reverses cellular aging',              tag: 'Overhyped', style: 'hyped'  as TagStyle },
  { text: 'Improves muscle strength & function',  tag: 'Mostly Null',style: 'mixed'  as TagStyle },
  { text: 'Every brand is the same quality',      tag: 'False',     style: 'hyped'  as TagStyle },
];

export const Scene3NADClaims: React.FC<Props> = ({ frame, captionChunks }) => {
      ...
      {CLAIMS.map((claim, i) => {
        ...
        return (
          <div key={i} style={{
            ...
            <div style={{
              fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 26, letterSpacing: '0.05em',
              textTransform: 'uppercase', padding: '8px 20px', flexShrink: 0, whiteSpace: 'nowrap',
