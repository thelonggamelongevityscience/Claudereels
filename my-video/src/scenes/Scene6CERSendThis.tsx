...
export const Scene6CERSendThis: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: BG, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 900, fontSize: 90, lineHeight: 0.88, textTransform: 'uppercase', color: COLORS.white, marginBottom: 36 }}>
        SEND THIS TO<br />SOMEONE HYPING<br />THEIR COLD<br />PLUNGE.
      </div>
