...
export const Scene5BONHowToProtect: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const items = [
    { label: 'Resistance train 2 to 3x weekly:', body: 'mechanical load is what signals bone to rebuild.', op: li1Op, x: li1X },
    { label: 'Add impact:', body: 'jogging, jumping, or brisk stair climbing provide a stimulus low-impact training doesn\'t.', op: li2Op, x: li2X },
    { label: 'Hit protein and calcium targets daily:', body: 'both are raw materials your body can\'t substitute.', op: li3Op, x: li3X },
    { label: 'Get vitamin D tested:', body: 'deficiency is common and easily corrected once identified.', op: li4Op, x: li4X },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 72, lineHeight: 0.92, textTransform: 'uppercase', color: COLORS.green, marginBottom: 28 }}>
        TRAIN BONE LIKE<br />YOU'D TRAIN<br />MUSCLE.
      </div>
