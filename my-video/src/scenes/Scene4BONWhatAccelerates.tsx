...
export const Scene4BONWhatAccelerates: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const items = [
    { label: 'No resistance or impact training:', body: 'bone only strengthens under mechanical load — low-impact cardio alone does very little for it.', op: li1Op, x: li1X },
    { label: 'Chronically low protein and calcium:', body: 'bone remodelling requires consistent raw material.', op: li2Op, x: li2X },
    { label: 'Excess alcohol and smoking:', body: 'both directly impair bone-building cells and accelerate loss.', op: li3Op, x: li3X },
    { label: 'Undiagnosed low vitamin D:', body: "without it, your body can't absorb calcium regardless of intake.", op: li4Op, x: li4X },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 72, lineHeight: 0.92, textTransform: 'uppercase', color: COLORS.white, marginBottom: 28 }}>
        WHAT'S QUIETLY<br />DRAINING YOUR<br />BONE DENSITY.
      </div>
