...
export const Scene7MetabolicCTA: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: tagOp, fontFamily: FONTS.mono, fontSize: 20, color: 'rgba(255,77,109,0.4)', lineHeight: 1.6 }}>
        #metabolichealth #insulinresistance #longevity<br />#metabolicsyndrome #bloodsugar #healthspan
      </div>
