...
export const Scene3CRPWhyItMatters: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const items = [
    { label: 'Half of heart attacks:', body: 'occur in people with normal cholesterol — hs-CRP catches risk that cholesterol testing alone misses completely.', op: li1Op, x: li1X },
    { label: 'Silent damage:', body: 'chronic low-grade inflammation damages blood vessel walls for years before any symptom appears.', op: li2Op, x: li2X },
    { label: 'Not automatic:', body: "hs-CRP isn't on a standard lipid panel — you have to specifically ask for it by name.", op: li3Op, x: li3X },
    { label: 'Easy to add:', body: 'one blood draw, added to any routine panel, no special preparation required.', op: li4Op, x: li4X },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 68, lineHeight: 0.92, textTransform: 'uppercase', color: COLORS.white, marginBottom: 28 }}>
        NORMAL CHOLESTEROL.<br />ELEVATED RISK.<br />MISSED ENTIRELY.
      </div>
