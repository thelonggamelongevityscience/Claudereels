...
export const Scene8BONCTA: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: logoOp, transform: `translateY(${logoY}px)`, fontFamily: FONTS.barlow, fontWeight: 900, fontSize: 28, letterSpacing: '0.18em', textTransform: 'uppercase', color: COLORS.sand, marginBottom: 20 }}>
        THE LONG GAME
      </div>
      ...
      <div style={{ opacity: tagOp, transform: `translateY(${tagY}px)`, fontFamily: FONTS.playfair, fontStyle: 'italic', fontSize: 28, color: COLORS.greige, lineHeight: 1.5, marginBottom: 36 }}>
        Follow for more and save this before<br />
        <strong style={{ color: COLORS.sand }}>your next checkup.</strong>
      </div>
      ...
      <div style={{ opacity: hashOp, transform: `translateY(${hashY}px)`, fontFamily: FONTS.mono, fontSize: 18, color: COLORS.grey, lineHeight: 1.8 }}>
        #bonedensity #osteoporosis #longevity<br />
        #strengthtraining #agingwell
      </div>
