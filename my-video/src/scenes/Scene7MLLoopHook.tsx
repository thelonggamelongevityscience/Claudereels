...
export const Scene7MLLoopHook: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const hlLines = [
    { text: 'WHAT TIME',   op: h1Op, y: h1Y },
    { text: 'DID YOU GET', op: h2Op, y: h2Y },
    { text: 'OUTSIDE',     op: h3Op, y: h3Y },
    { text: 'TODAY?',      op: h4Op, y: h4Y },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ width: `${lineW}%`, height: 3, backgroundColor: COLORS.gold, margin: '20px 0 18px' }} />
      ...
      <div style={{ opacity: subOp, transform: `translateY(${subY}px)`, fontFamily: FONTS.playfair, fontStyle: 'italic', fontSize: 30, color: COLORS.greige, lineHeight: 1.5 }}>
        Before coffee. Before your phone. Before anything else.<br />
        <strong style={{ color: COLORS.white, fontStyle: 'normal' }}>Drop your time below 👇</strong>
      </div>
