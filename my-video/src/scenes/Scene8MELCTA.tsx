...
export const Scene8MELCTA: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: tagOp, fontFamily: FONTS.mono, fontSize: 20, color: `${COLORS.purple}66`, lineHeight: 1.6 }}>
        #melatonin #sleepscience #supplements<br />#longevity #circadianrhythm #sleephealth
      </div>
