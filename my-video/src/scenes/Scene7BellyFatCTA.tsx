...
export const Scene7BellyFatCTA: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: brandOp, transform: `translateY(${brandY}px)`, marginBottom: 40 }}>
        ...
        <div style={{ width: `${lineW}%`, height: 3, backgroundColor: COLORS.green, margin: '20px 0 16px' }} />
        <div style={{ fontFamily: FONTS.barlow, fontWeight: 700, fontSize: 22, letterSpacing: '0.25em', textTransform: 'uppercase', color: COLORS.green }}>LONGEVITY SCIENCE</div>
      </div>

      <div style={{ opacity: btn1Op, border: `2px solid ${COLORS.green}`, padding: '24px 32px', marginBottom: 16 }}>
        <div style={{ fontFamily: FONTS.barlow, fontWeight: 700, fontSize: 28, letterSpacing: '0.1em', textTransform: 'uppercase', color: COLORS.green }}>→ Save this</div>
      </div>
      ...
      <div style={{ opacity: tagOp, fontFamily: FONTS.mono, fontSize: 20, color: `rgba(0,255,133,0.4)`, lineHeight: 1.6 }}>
        #bellyfat #visceralfat #metabolichealth<br />#cortisol #insulinresistance #longevity
      </div>
