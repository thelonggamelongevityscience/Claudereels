...
export const Scene4CRPWhatRaisesIt: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const items = [
    { label: 'Ultra-processed food and seed oils:', body: 'drive chronic low-grade inflammation directly.', op: li1Op, x: li1X },
    { label: 'Visceral fat:', body: 'around organs is metabolically active and produces inflammatory signals continuously.', op: li2Op, x: li2X },
    { label: 'Chronic stress:', body: 'keeps cortisol elevated, which itself promotes systemic inflammation.', op: li3Op, x: li3X },
    { label: 'Poor sleep:', body: 'raises inflammatory markers measurably, even after just one bad night.', op: li4Op, x: li4X },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 800, fontSize: 72, lineHeight: 0.92, textTransform: 'uppercase', color: COLORS.white, marginBottom: 28 }}>
        FOUR THINGS<br />QUIETLY KEEPING<br />IT ELEVATED.
      </div>
