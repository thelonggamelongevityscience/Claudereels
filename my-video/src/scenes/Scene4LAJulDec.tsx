...
const ROWS = [
  { month: 'July',      name: 'The Relentless One' },
  { month: 'August',    name: 'The Immortal Mindset' },
  { month: 'September', name: 'The Chaotic Good' },
  { month: 'October',   name: 'The Ancestral Type' },
  { month: 'November',  name: 'The Structured Mind' },
  { month: 'December',  name: 'The Locked-In One' },
];

export const Scene4LAJulDec: React.FC<Props> = ({ frame, captionChunks }) => {
