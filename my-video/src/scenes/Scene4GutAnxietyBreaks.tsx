...
export const Scene4GutAnxietyBreaks: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const bullets = [
    { delay: 28, label: 'Ultra-processed food:', text: 'emulsifiers and preservatives alter microbiome composition within 24 hours' },
    { delay: 38, label: 'Chronic stress:', text: 'cortisol increases gut permeability — leaky gut sends inflammatory signals to the brain' },
    { delay: 48, label: 'Antibiotics:', text: 'wipe out beneficial bacteria indiscriminately — mood effects can persist for months' },
    { delay: 58, label: 'Poor sleep:', text: 'disrupts the overnight microbiome regeneration cycle, compounding the gut-anxiety loop' },
  ];
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: COLORS.black, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      {(['WHAT IS', 'DISRUPTING YOUR', 'GUT-BRAIN AXIS.'] as const).map((text, i) => (
