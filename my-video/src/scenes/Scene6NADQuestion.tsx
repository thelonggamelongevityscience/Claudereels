...
export const Scene6NADQuestion: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  return (
    <div style={{ width: 1080, height: 1920, backgroundColor: BG, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 72px' }}>
      ...
      <div style={{ opacity: hlOp, transform: `translateY(${hlY}px)`, fontFamily: FONTS.barlow, fontWeight: 900, fontSize: 112, lineHeight: 0.88, textTransform: 'uppercase', color: COLORS.white, marginBottom: 36 }}>
        Supplementing<br />Blind?
      </div>
      ...
      <div style={{ opacity: subOp, transform: `translateY(${subY}px)`, fontFamily: FONTS.playfair, fontStyle: 'italic', fontSize: 38, color: COLORS.greige, lineHeight: 1.45, marginBottom: 32 }}>
        Or do you actually know your biological age first?<br /><strong style={{ color: COLORS.white }}>Comment AGING and find out.</strong>
      </div>
