...
export const Scene7NCLoopHook: React.FC<Props> = ({ frame, captionChunks }) => {
  ...
  const hlLines = [
    { text: 'HOW MANY',    op: h1Op, y: h1Y },
    { text: 'NIGHTS IS',   op: h2Op, y: h2Y },
    { text: 'IT ACTUALLY', op: h3Op, y: h3Y },
    { text: 'HELPING?',    op: h4Op, y: h4Y },
  ];
